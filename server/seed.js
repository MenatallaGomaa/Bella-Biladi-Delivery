...
const items = [
  ...
  {
    name: "Cheeseburger",
    description: "Saftiger Rindfleischburger mit Käse. Inklusive kleine Pommes Frites.",
    priceCents: 990,
    category: "Burger",
  ...
  {
    name: "Chickenburger",
    description: "Knuspriges Hähnchenfilet im Burger. Inklusive kleine Pommes Frites.",
    priceCents: 990,
    category: "Burger",
    imageUrl: "/burger.jpeg",
  },
  {
    name: "Vegan Burger",
    description: "Pflanzlicher Patty mit frischem Gemüse. Inklusive kleine Pommes Frites.",
    priceCents: 990,
    category: "Burger",
    imageUrl: "/burger.jpeg",
  },
